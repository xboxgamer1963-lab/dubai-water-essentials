...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = "43biyp-sz.myshopify.com";
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = "c5f54c5ff2b0ace1cea0438b93b372c5";
...
export async function fetchCart(cartId: string): Promise<{ cart: { id: string; totalQuantity: number } | null } | null> {
